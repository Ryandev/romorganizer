...
export default function builder(parameters: string[]): RunnerBuilder<string[]> {
    ...
    return {
        create: () => Promise.resolve(new RunnerDirectory(parsedArguments.sourceDir, parsedArguments.outputDir, parsedArguments.tempDir, parsedArguments.overwrite, parsedArguments.removeSource)),
