...
describe('Hash Utilities', () => {
    describe('calculateFileSha1', () => {
        it('should calculate correct SHA1 hash for text files', async () => {
            ...
            const testContent = 'Hello, World! This is a test file for SHA1 calculation.';
            ...
            try {
                ...
                const realKnownSha1 = createHash('sha1').update(testContent, 'utf8').digest('hex');
        ...
        it('should calculate correct SHA1 hash for binary files', async () => {
            ...
            const testContent = Buffer.from([0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09]);
        ...
        it('should calculate correct SHA1 for real South Park BIN file', async () => {
            const realFilePath = '/Users/ats/Desktop/assets/South Park (USA) (Track 1).bin';
            ...
            try {
                ...
                console.log(`Real file test skipped: ${error instanceof Error ? error.message : String(error)}`);
                console.log(`Expected SHA1: ${expectedSha1}`);
                console.log(`File path: ${realFilePath}`);
            }
        });
